...
public class Record {
	...
	public String toString() {
		...
		/*
		 * for (int i = 0; i < table.getColIDs().length; i++) { String
		 * columnName = table.getColIDs()[i].getColumnName(); Object value =
		 * getValue(columnName); s += columnName + " = " + value.toString(); if
		 * (i < table.getColIDs().length - 1) s += ", "; }
		 */
