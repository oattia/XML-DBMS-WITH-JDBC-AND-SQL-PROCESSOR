...
public class DTDGenerator extends org.xml.sax.helpers.DefaultHandler {
	...
	TreeMap elementList; // alphabetical list of element types appearing in the
							// document;
							// each has the element name as a key and an
							// ElementDetails object
							// as the value

	Stack elementStack; // stack of elements currently open; each entry is a
						// StackEntry
						// object
	...
	private void printDTD(String dtdFilePath) throws IOException {
		...
		while (e.hasNext()) {
			...
			while (a.hasNext()) {
				...
				// TODO: this may give the wrong answer, we should check whether
	...
	public void startElement(String uri, String localName, String name,
		...
		if (!elementStack.isEmpty()) {
			...
			boolean isFirstInGroup = (parent.latestChild == null || (!parent.latestChild
					.equals(name)));
			if (isFirstInGroup) {
				seq++;
